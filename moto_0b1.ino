 ...
 * ver.0.b1 - - brake & few short flashes on turn left +right
 * 
 */
...
byte semnal0 = 0;  // stare intermitenta functie de timp la franare
...
while ((digitalRead(inFR) == LOW) and (frana == 1))
{
  semnal0 = (millis()/100)%2;
  digitalWrite(S1, semnal0);
  digitalWrite(S2, semnal0);
